...
*/
#ifndef __APPLICATION_GAMEFINISHEDSTATE_H
#define __APPLICATION_GAMEFINISHEDSTATE_H
...
namespace Application 
{
	class CGameFinishedState : public CApplicationState
	{
	public:
		CGameFinishedState(CBaseApplication *app, Common::Data::GameType type,
							Ogre::Root* root,
							Ogre::RenderWindow* render) : CApplicationState(app, type,root,render)
		{}
		virtual ~CGameFinishedState();
