...
#ifndef __LOGIC_PLANET_TRIGGER_H
#define __LOGIC_PLANET_TRIGGER_H
...
namespace Logic
{
	namespace Component
	{
		class CPlanetTrigger : public CPhysicEntity
		{
			DEC_FACTORY(CPlanetTrigger);
		public:
